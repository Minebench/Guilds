    ...
    public void execute(CommandSender commandSender, String[] strings) {
        ...
        if (sender.hasPermission("Guilds.acceptAllianceInvite")) {
            ...
            if (guild != null) {
                ...
                if (invite != null) {
                    plugin.getAllianceManager().acceptInvite(invite);
                    ...
                    plugin.getChat().sendAllianceChannelBroadcast(invite.getAlliance(),
                            plugin.getGuildsConfig()
                                    .getText("info.chat.guildJoinedAlliance").replace("{0}", guild.getName()));
